...
<head>
    ...
    <link rel="stylesheet" href="{{ asset("/vendor/scribe-orders/css/theme-default.style.css") }}" media="screen">
    <link rel="stylesheet" href="{{ asset("/vendor/scribe-orders/css/theme-default.print.css") }}" media="print">
    ...
    <script src="{{ asset("/vendor/scribe-orders/js/tryitout-5.3.0.js") }}"></script>

    <script src="{{ asset("/vendor/scribe-orders/js/theme-default-5.3.0.js") }}"></script>
...
<a href="#" id="nav-button">
    <span>
        MENU
        <img src="{{ asset("/vendor/scribe-orders/images/navbar.png") }}" alt="navbar-image"/>
    </span>
</a>
<div class="tocify-wrapper">
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="order-management">
                    <a href="#order-management">Order Management</a>
                                ...
                                <a href="#order-management-GETapi-orders">GET api/orders</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="order-management-POSTapi-orders">
                                <a href="#order-management-POSTapi-orders">Store a newly created order</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="order-management-GETapi-orders--id-">
                                <a href="#order-management-GETapi-orders--id-">Display the specified order</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="order-management-PUTapi-orders--id-">
                                <a href="#order-management-PUTapi-orders--id-">Update the specified order</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="order-management-DELETEapi-orders--id-">
                                <a href="#order-management-DELETEapi-orders--id-">Remove the specified order from storage</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="order-management-POSTapi-orders--order_id--cancel">
                                <a href="#order-management-POSTapi-orders--order_id--cancel">Cancel an order</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="order-management-GETapi-orders-statistics-overview">
                                <a href="#order-management-GETapi-orders-statistics-overview">Get order statistics (Admin only)</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="order-management-POSTapi-orders--order_id--status">
                                <a href="#order-management-POSTapi-orders--order_id--status">Update order status (Admin only)</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
    ...
    <ul class="toc-footer" id="toc-footer">
                    <li style="padding-bottom: 5px;"><a href="{{ route("scribe-orders.postman") }}">View Postman collection</a></li>
                            <li style="padding-bottom: 5px;"><a href="{{ route("scribe-orders.openapi") }}">View OpenAPI spec</a></li>
...
<p>Tài liệu API cho quản lý Order (Đơn hàng).</p>
<aside>
    <strong>Base URL</strong>: <code>http://localhost</code>
</aside>
<pre><code>Tài liệu này cung cấp thông tin chi tiết về API Order của hệ thống e-commerce.
...
&lt;aside&gt;Khi bạn cuộn, bạn sẽ thấy các ví dụ code để làm việc với API trong các ngôn ngữ lập trình khác nhau ở phía bên phải.&lt;/aside&gt;</code></pre>
...
<p>Bạn có thể lấy token bằng cách đăng nhập vào hệ thống. Sử dụng session-based authentication cho web hoặc token-based cho API.</p>

        <h1 id="order-management">Order Management</h1>

    

                                <h2 id="order-management-GETapi-orders">GET api/orders</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="order-management-POSTapi-orders">Store a newly created order</h2>
...
Must be one of:
<ul style="list-style-type: square;"><li><code>pending</code></li> <li><code>processing</code></li> <li><code>completed</code></li> <li><code>cancelled</code></li> <li><code>return</code></li></ul>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
        <details>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="order_items.0.product_id"                data-endpoint="POSTapi-orders"
               value="architecto"
               data-component="body">
    <br>
...
<p>Must be at least 1. Example: <code>22</code></p>
                    ...
                    <h2 id="order-management-GETapi-orders--id-">Display the specified order</h2>
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost/api/orders/16';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<p>The ID of the order. Example: <code>16</code></p>
                    ...
                    <h2 id="order-management-PUTapi-orders--id-">Update the specified order</h2>
...
<ul style="list-style-type: square;"><li><code>pending</code></li> <li><code>processing</code></li> <li><code>completed</code></li> <li><code>cancelled</code></li> <li><code>return</code></li></ul>
                    ...
                    <h2 id="order-management-DELETEapi-orders--id-">Remove the specified order from storage</h2>
...
<p>The ID of the order. Example: <code>16</code></p>
                    ...
                    <h2 id="order-management-POSTapi-orders--order_id--cancel">Cancel an order</h2>
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost/api/orders/16/cancel';
$response = $client-&gt;post(
    $url,
    [
        'headers' =&gt; [
...
<p>The ID of the order. Example: <code>16</code></p>
                    ...
                    <h2 id="order-management-GETapi-orders-statistics-overview">Get order statistics (Admin only)</h2>
...
<span id="example-requests-GETapi-orders-statistics-overview">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/orders/statistics/overview" \
    --header "Authorization: Bearer Bearer {YOUR_AUTH_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/orders/statistics/overview"
);
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost/api/orders/statistics/overview';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-GETapi-orders-statistics-overview">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-orders-statistics-overview" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-orders-statistics-overview"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-orders-statistics-overview"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-orders-statistics-overview" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-orders-statistics-overview">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-orders-statistics-overview" data-method="GET"
      data-path="api/orders/statistics/overview"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-orders-statistics-overview', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-orders-statistics-overview"
                    onclick="tryItOut('GETapi-orders-statistics-overview');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-orders-statistics-overview"
                    onclick="cancelTryOut('GETapi-orders-statistics-overview');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-orders-statistics-overview"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/orders/statistics/overview</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-orders-statistics-overview"
               value="Bearer Bearer {YOUR_AUTH_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer Bearer {YOUR_AUTH_TOKEN}</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-orders-statistics-overview"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-orders-statistics-overview"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="order-management-POSTapi-orders--order_id--status">Update order status (Admin only)</h2>
...
<span id="example-requests-POSTapi-orders--order_id--status">
<blockquote>Example request:</blockquote>
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost/api/orders/16/status';
$response = $client-&gt;post(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-POSTapi-orders--order_id--status">
</span>
<span id="execution-results-POSTapi-orders--order_id--status" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-orders--order_id--status"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-orders--order_id--status"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-orders--order_id--status" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-orders--order_id--status">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-orders--order_id--status" data-method="POST"
      data-path="api/orders/{order_id}/status"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-orders--order_id--status', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-orders--order_id--status"
                    onclick="tryItOut('POSTapi-orders--order_id--status');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-orders--order_id--status"
                    onclick="cancelTryOut('POSTapi-orders--order_id--status');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-orders--order_id--status"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-orders--order_id--status"
               value="Bearer Bearer {YOUR_AUTH_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer Bearer {YOUR_AUTH_TOKEN}</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-orders--order_id--status"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-orders--order_id--status"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="order_id"                data-endpoint="POSTapi-orders--order_id--status"
               value="16"
               data-component="url">
    <br>
<p>The ID of the order. Example: <code>16</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="status"                data-endpoint="POSTapi-orders--order_id--status"
               value=""
               data-component="body">
    <br>
